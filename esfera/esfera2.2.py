...
entradas = np.loadtxt('/home/aye/Escritorio/hoy/krey/esfera/data/data.txt')

# Cargar los datos de salida
salidas = np.loadtxt('/home/aye/Escritorio/hoy/krey/esfera/data/labels.txt')
...
# Obtener los qubits
qubits = np.random.randint(0, 2, size=(len(nodos), len(nodos)))
# Generar los qubits
qubits = np.random.randint(0, 2, size=pesos.shape)
# Actualizar los pesos
pesos = pesos * qubits
